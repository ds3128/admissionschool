package org.darius.payment.controllers.advices;
...
public class GlobalExceptionHandler {
    ...
    public ProblemDetail handleNotFound(ResourceNotFoundException ex) {
        ...
        p.setType(URI.create("/errors/not-found")); p.setTitle("Ressource introuvable"); return p;
    }

    @ExceptionHandler(DuplicateResourceException.class)
    public ProblemDetail handleDuplicate(DuplicateResourceException ex) {
        ProblemDetail p = ProblemDetail.forStatusAndDetail(HttpStatus.CONFLICT, ex.getMessage());
        p.setType(URI.create("/errors/conflict")); p.setTitle("Ressource dupliquée"); return p;
    }
    ...
    public ProblemDetail handleInvalid(InvalidOperationException ex) {
        ...
        p.setType(URI.create("/errors/invalid-operation")); p.setTitle("Opération invalide"); return p;
    }

    @ExceptionHandler(ForbiddenException.class)
    public ProblemDetail handleForbidden(ForbiddenException ex) {
        ProblemDetail p = ProblemDetail.forStatusAndDetail(HttpStatus.FORBIDDEN, ex.getMessage());
        p.setType(URI.create("/errors/forbidden")); p.setTitle("Accès refusé"); return p;
    }
    ...
    public ProblemDetail handleUnavailable(ServiceUnavailableException ex) {
        ...
        p.setType(URI.create("/errors/service-unavailable")); p.setTitle("Service indisponible"); return p;
    }
    ...
    public ProblemDetail handleValidation(MethodArgumentNotValidException ex) {
        ...
        p.setType(URI.create("/errors/validation")); p.setTitle("Erreurs de validation");
    ...
    public ProblemDetail handleGeneric(Exception ex) {
        ...
        p.setType(URI.create("/errors/internal")); p.setTitle("Erreur interne"); return p;
    }
}
