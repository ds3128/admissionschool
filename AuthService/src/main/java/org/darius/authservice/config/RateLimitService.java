...
//    public boolean isBlocked(String email) {
//        try {
//            return Boolean.TRUE.equals(redisTemplate.hasKey("login:blocked:" + email));
//        } catch (Exception e) {
//            return false; // Redis indisponible → on laisse passer
//        }
//    }
//
//    public void registrationFailedAttempt(String email) {
...
//                redisTemplate.opsForValue().set(
//                        "login:blocked:" + email, "true", BLOCK_MINUTES, TimeUnit.MINUTES
//                );
//                redisTemplate.delete(key);
//            }
...
//            redisTemplate.delete("login:blocked:" + email);
//        } catch (Exception ignored) {}
//    }
//
//    public int getAttempts(String email) {
//        try {
//            String val = redisTemplate.opsForValue().get("login:attempts:" + email);
//            return val != null ? Integer.parseInt(val) : 0;
//        } catch (Exception e) {
//            return 0;
//        }
...
//    public long getRemainingBlockTime(String email) {
//        try {
//            Long ttl = redisTemplate.getExpire("login:blocked:" + email, TimeUnit.SECONDS);
//            return ttl != null ? ttl : 0;
//        } catch (Exception e) {
//            return 0;
//        }
