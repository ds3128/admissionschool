...
**Changelog v3 :**
- Ajout des flux distincts par niveau : Licence, Master, Doctorat
- Ajout de la commission pédagogique avec vote à la majorité
- Ajout de la gestion des entretiens (Master / Doctorat)
- Ajout de l'accord préalable du directeur de thèse (Doctorat)
- Ajout de la liste d'attente active avec rang et promotion automatique
- Cycle d'admission avec période d'ouverture définie (ex : janvier → avril)
...
6. Application → `SUBMITTED`, dossier verrouillé, événement `ApplicationSubmitted` publié.
